...
int duty_cycle=63;;  //   (10% 25.5)||(16% 40.8)||(25% 63.75)||(30% 76.5)||(40% 102)||(50% 127.5)||(100% 255) ,if above 800us or 80% duty cycle rule changes
...
void loop()
{
  ...
  if (start_flag == true)
  {
    ...
    if (voltage > 100) {
      if ((650 < voltage) && (voltage < 900)) //12v
      {
      ...
      else if ((480 < voltage) && (voltage < 600 )) //9v
      {
